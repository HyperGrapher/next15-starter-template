      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            ...
            <div className="relative mt-12 bg-zinc-800 rounded-xl sm:mx-auto sm:max-w-lg lg:col-span-6 lg:mx-0 lg:mt-0 lg:flex lg:max-w-none lg:items-center">
              <p className="mx-auto text-zinc-500"> (Place an image here)</p>
            </div>
          </div>
        </div>
      </section>
